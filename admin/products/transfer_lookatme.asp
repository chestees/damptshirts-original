...
If btnSubmit <> "" Then
	...
	varString = replace(varString, "products-grid", "")
	varString = replace(varString, "odd", "")
	varString = replace(varString, "even", "")
	varString = replace(varString, "first", "")
	varString = replace(varString, "last", "")
	varString = replace(varString, "item", "")
	...
	dtDate = Date()
	intDiggStoreID = 16
	intTagID = 556 'Look at me Shirts
...
<div id="rightCol">
	...
	<div class="content">
		<h1>PRODUCTS :: Look at Me Shirts</h1>
