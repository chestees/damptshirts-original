<%@ Page Title="Site Map" Language="C#" MasterPageFile="~/DampTShirts.master" AutoEventWireup="true" CodeFile="sitemap.aspx.cs" Inherits="sitemap" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
  <div class="main clearfix">
    <div class="main_left">
      ...
      <h1>Sitemap</h1>
      <a href="/sitemap.xml">View Site Map</a>
    </div>
  </div>
</asp:Content>
